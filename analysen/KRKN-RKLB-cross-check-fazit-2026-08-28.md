# CROSS-CHECK-FAZIT: Kraken Robotics & Rocket Lab (Scout-Pfad, 3-KI)
**Datum:** 2026-08-28 · **Regelwerk:** Conan-the-Scout v1.12 · **Modus:** Quick Scout, gemeinsames Schritt-0-Datenpaket, unabhängige Bewertung

## Kraken Robotics (TSXV:PNG/OTC:KRKNF) – Vergleich

| | Jarvis (Claude) | Jack (Gemini) | Conan (ChatGPT) |
|---|---|---|---|
| DNA-Urteil | K 4/5 (Grenzfall F&E) | K-Abbruch (F&E [N/V]) | "bestanden, knapp, mit Vorbehalt" |
| Moat | 3/4 solide | 3/4 | 7/10 (~2,8/4) |
| Rating | BEOBACHTEN-SPEKULATIV | BEOBACHTEN-SPEKULATIV | WATCHLIST-ELITE/BEOBACHTEN |
| Sizing | <0,5% | <0,5% | Tier 3 |
| Score | 6/10 | 5/10 | 7,1/10 |
| Konfidenz | 🟡 | 🟡 | 60% gelb-grün |

**Konvergenz:** STARK auf Handlungsebene – alle drei landen bei einer vorsichtigen Beobachten-Einstufung mit kleiner/Trace-Sizing, keiner sieht einen Kaufgrund für Nachkauf. Alle drei benennen unabhängig denselben Kernpunkt: der große FY2026-Umsatzsprung ist M&A-getrieben (Covelya), nicht organisch, und die Schiedsverfahrens-Rückstellung/Revenue-Reversal aus Q2 ist ein Ergebnis-Visibilitäts-Warnsignal. Einzige Nuance: Conan vergibt einen sichtbar höheren Score/Rating-Namen ("WATCHLIST-ELITE/BEOBACHTEN") als die anderen beiden – vermutlich weniger strikt an die Nullhypothese-Pflicht gebunden.

## Rocket Lab (NASDAQ:RKLB) – Vergleich

| | Jarvis (Claude) | Jack (Gemini) | Conan (ChatGPT) |
|---|---|---|---|
| DNA-Urteil | K 2-3/5 → Abbruch | K 3/5 → Abbruch (explizit benannt) | narrativ, kein harter Abbruch |
| Moat | (informell, kein Score) | 4/4 | 8/10 |
| Rating | **ZU FRÜH** | **BEOBACHTEN-STARK** | **BEOBACHTEN** |
| Sizing | 0% (nur Neukauf-Bewertung) | 0,5-1,5% | Tier 3 |
| Score | nicht formal vergeben | 7/10 | 7,4/10 |
| Konfidenz | 🟡 (Hype-Strike aktiv) | 🟡 | 65% gelb-grün |
...
Bei Kraken Robotics sind sich alle drei KIs einig: kleine Beobachtungs-/Trace-Position ist angemessen, die bestehenden 300 Stück bleiben unangetastet, kein Grund zum Nachkaufen vor den nächsten 2-3 Quartalen ohne weitere Sondereffekte.
