...
## 🔄 Nachtrag 2026-09-21 — Refresh (4-Tage-Fenster, kein neuer Full-Dive von null)

Auf Brians Anweisung ("führe nochmal einen ANET Full Deep Dive durch, nimm die Vorlage von der letzten Deep-Dive-Analyse") wurde geprüft, ob sich seit dem 17.09. etwas Ratingrelevantes verändert hat — nicht die gesamte DNA-Check-/KSF-Herleitung neu durchlaufen, da sich innerhalb von 4 Handelstagen keine neue Quartalszahl ergibt.

**Live-Daten (Aegis, Twelve Data):** Kurs $202,58 (21.09.2026, +2,55% ggü. 17.09.), Tagesspanne $200,745-$204,445, 52W-Range unverändert $114,52-$214,89.

**Neue Fakten seit 17.09.:**
1. **S&P-100-Aufnahme, wirksam vor Handelsbeginn 21.09.2026.** Vier Titel rücken aus dem breiteren S&P 500 in den S&P 100 auf: Dell Technologies, Palo Alto Networks, **Arista Networks**, SanDisk. Vier verlassen ihn: Nike, Honeywell Aerospace, Simon Property Group, Colgate-Palmolive. **Korrektur einer eigenen Aegis-Verkürzung:** ursprünglich als "ANET ersetzt Nike" 1:1 formuliert — Conan wies zu Recht darauf hin, dass die Paarung laut offizieller S&P-DJI-Tabelle nicht 1:1 ist (ANET steht dort neben der SPG-Streichung). Per WebSearch direkt gegen die S&P-DJI-eigene Ankündigung (04.09.2026) verifiziert und korrigiert. Bewertungslogisch bleibt es ein reiner **Index-/Flow-Katalysator** (passive Nachfrage, Liquidität), kein operativer Cashflow-Katalysator. [VERIFIED, Primärquelle S&P DJI]
2. **Dritte Guidance-Anhebung des Jahres:** FY2026-Umsatzausblick jetzt ~$12,6 Mrd. (+40% YoY), $1,1 Mrd. über der Mai-Prognose, $2,1 Mrd. über dem ursprünglichen Analyst-Day-Ziel ($10,5 Mrd.). Q2 2026 Umsatz $3,04 Mrd. (+37,7% YoY) — erstes Quartal über $3 Mrd. Etherlink-AI-Switches bedienen jetzt &gt;100 Kunden (von 4-5 in 2024), Management-Ziel jetzt ≥$3,6 Mrd. AI-Fabric-Umsatz 2026. [VERIFIED, SEC-Earnings-Release + mehrere Finanzmedien]
3. **Insider:** SEC-Form-4-Direktabruf zeigt für September nur non-cash Trust-Umschichtungen (8./10.09., 10b5-1-Plan vom 11.03.2026) — die ursprünglich per WebSearch gefundene Angabe "Kenneth Duda verkaufte ~10k Stück am 17.09. zu ~$142" konnte **nicht verifiziert werden und wurde verworfen** (Kurs lag zu diesem Zeitpunkt bei $195-205, $142 ist damit unplausibel — vermutlich Verwechslung mit einer älteren Juni/Juli-Transaktion aus einer anderen Preistranche). Dokumentiertes Muster bleibt unverändert: überwiegend planmäßige 10b5-1-Trust-Bewegungen, kein Panikverkaufsmuster, aber auch kein Insider-Buying.

**JJ-Update (frisch dispatcht, Google-Search-Grounding aktiv):** hebt DCF spürbar an — Bear $175-180 (von $158,55), Base $240-250 (von $214,28), Bull $350-365 (von $310,48) — Begründung: eigene 5J-Umsatz-CAGR-Annahme (26,9%) sei durch die bestätigte 40%-Dynamik zu konservativ gewesen, S&P-100-Aufnahme senke zusätzlich das implizite Risiko. **Rating tendiert jetzt Richtung KAUFEN** (Base klar über Kurs). Frischer TA-Check: RSI 51-56 (neutral-bullisch), MACD bullish (Linie über Signal), Golden-Stack intakt, Kurs nahe 52W-Hoch/oberhalb Bollinger — TA-Verdikt von HALTEN/BEOBACHTEN zu **HALTEN/KAUFEN bei Schwäche**.

**Conan-Update (frisch dispatcht, Web-Search aktiv):** hebt DCF nur moderat an — Bear ~$70 (von $65), Base $142-148/Mittelpunkt ~$145 (von $130-135), Bull $235-245/Mittelpunkt ~$240 (von $220). Bleibt explizit bei der 65/35-Gordon/Exit-Multiple-Gewichtung (Sensitivitätscheck: selbst 60/40 ergäbe nur ~$148-152) — Begründung unverändert: die Guidance-Anhebung verbessert Jahre 1-4 des Modells, beweist aber nicht, dass ANET in Jahr 8-10+ die Preissetzungsmacht gegen NVIDIA-Bundles dauerhaft hält; S&P-100-Aufnahme sei Flow-, kein DCF-Treiber. **Rating bleibt NEUTRAL/WATCHLIST, Score 74→76/100** (Kurs weiterhin ~35-40% über Conans Base). TA-Verdikt: HALTEN/BEOBACHTEN mit leicht bullischem Bias, kein Chasing am oberen Bollinger-Band (Widerstand $203-205/$208/52W-Hoch $214,9, Support $199/197 → $193-194 → $187).

**Aegis-Einordnung (kein neuer Diskussionsrunden-Anlass):** Die Divergenz zwischen JJ und Conan ist strukturell dieselbe wie am 17.09. (Streit um TV-Methodik/Terminal-Moat, nicht um Fakten) — durch die Guidance-Anhebung hat sich die Bandbreite insgesamt nach oben verschoben, aber die Dissensus-Map-Diagnose vom 17.09. bleibt unverändert gültig, kein neuer Klärungsbedarf. Eigener 10J-Exit-Multiple-Ansatz moderat angehoben: Bear $125 (von $116), Base $250 (von $245), Bull $460 (von $449) — die bestätigte Wachstumsbeschleunigung war in der ursprünglichen 10-Jahres-Modellierung bereits teilweise vorweggenommen, daher nur kleine Anpassung, kein Sprung wie bei JJs kürzerem 5J-Horizont.

**Rating unverändert: BEOBACHTEN, Agent Score 7-8/10, Konfidenz 🟡 MITTEL (tendenziell gestärkt).** Die faire-Wert-Spanne hat sich weiter verbreitert ($70-460 statt $65-449) statt verengt — dieselbe ehrliche Unsicherheit wie am 17.09., nur auf höherem Kursniveau. Champions-Fit weiterhin ja, sofortige hohe Konviktion weiterhin nein: der Kurs bewegt sich near dem 52-Wochen-Hoch, exakt an der Stelle, wo Conans disziplinierte Skepsis am stärksten wiegt.

**Quellen (zusätzlich zu oben):** S&P Dow Jones Indices, offizielle Ankündigung 04.09.2026 (S&P-100-Änderungen); SEC-Earnings-Release Q2 2026 (Guidance-Anhebung); SEC Form 4 Filings (direkt abgerufen, September-Transaktionen).
