...
**Ungelöste Datenlücke — AUFGELÖST 2026-09-09 (zweiter Anlauf, auf Brians Bitte "beide umsetzen"):** die FCF-Quellendivergenz ($8,93 Mrd. Fact-Pack vs. DKK 28,3 Mrd. Annual Report) ist geklärt. Novos Annual Report 2025 definiert FCF explizit als "operativer Cashflow minus PP&E-Capex" und weist DKK 28,3 Mrd. FY2025 aus (Cashflow-Brücke: OCF ≈ DKK 88,4 Mrd. − PP&E-Capex DKK 60,1 Mrd. = DKK 28,3 Mrd.; PP&E-Capex-Anstieg ggü. 2024 (47,2 Mrd.) durch API-/Fill-Finish-Kapazitätsausbau). Der $8,93-Mrd.-Wert war ein nicht-primärquellenbasierter, vermutlich veralteter Aggregator-Wert — per Primärquellen-Standard (Rigor-Punkt 29) zurückgestuft. **Konsequenz:** DNA-Check-FCF-Marge (Seite 3) von 19,1% auf die korrekte 9,2% (28,3/309,064 Mrd.) korrigiert — K-Kriterium bleibt ❌, aber deutlich klarer verfehlt als zuvor dargestellt. Die DCF (Seite 6) nutzte den Wert nicht direkt als Modell-Input (eigene Wachstums-/Margenpfade), daher keine weitere Korrektur an den Fair-Value-Zahlen nötig.

**Amycretin-Timing in Kill-Sheet/Fazit zurückverdrahtet (2026-09-09):** die neue Pipeline-Seite (9) war zunächst nicht mit dem Thesis-Kill-Sheet (Seite 7) und dem Finalen Fazit (Seite 10) verknüpft. Nachgetragen: neue Zeile "2027-2029 (langfristig)" im Kill-Sheet-Prüfpunkt-Kalender, 5. Aufstufungs-Trigger (Amycretin-Phase-3-Bestätigung), "Nächster Trigger"-Feld im Fazit zeigt jetzt kurz- UND langfristig (CMD 21.09. / Amycretin P3). Wichtige Präzisierung dabei: laut GlobalData-Projektion ist Amycretin ein Katalysator für 2027-2030 (T2D-Marktzugang nicht vor 2028-2029, Obesity-Zulassung USA nicht vor Q4 2030), kein kurzfristiger Trigger wie der CMD.
