...
**Aktueller Stand:** 30 Werte gesamt – **Champions: 14 · Profi: 11 · Talent: 5** (Stand 2026-09-04, nach Umkategorisierung Lasertec Talent→Champions und Asahi Intecc Talent→Profi – siehe jeweilige Zeilen und Änderungsprotokoll unten)
...
|---|---|---|---|---|---|
| 🏆 Champions (14) | NVDA, V, MA, SPGI, TSM, FICO, CPRT, ROL (8) | SYK, Keyence, Brookfield, Lasertec (4) | ASML, Hoya (2) | – | – |
| ⚙️ Profi (11) | WSO (1) | VRT, FTNT, MPWR, AIT, Disco Corp, Asahi Intecc (6) | ANET, Exponent (2) | nVent Electric (1) | CrowdStrike (1) |
| 🚀 Talent (5) | USLM (1) | Innodata, SKWD (2) | – | Palantir, Rorze (2) | – |
...
## 🏆 Champions (14) – etablierte Weltklasse-Compounder
