...
| 7747 (Tokyo) | JP3110650003 | Asahi Intecc Co. | Japan | MedTech (Führungsdrähte für Katheter) | BRIAN | 🆕 | 🟡 FAIR BEWERTET (aktualisiert 09.09.2026, Wiederholungslauf nach Einführung der Kennzahlen-Recherche-Pflicht — **CRV-Ampel von 🟢 auf 🟡 korrigiert**) – Kurs ¥3.261 (Brians Live-Quelle 09.09.2026). **Wiederholungslauf deckte 3 von 5 K-Kriterien-Werten als Fehleinschätzungen des Erstlaufs auf**, nachdem Jack jede Kennzahl gezielt nachrecherchieren musste (statt ungeprüfter Schätzung): ROIC real nur 19,7% (Investing.com, vorher fälschlich 23,21% "ältere Session-Recherche" angenommen) – verfehlt die 20%-Schwelle; EPS-CAGR(5J) real nur 5,99% mit erwartetem leichten Rückgang nächstes Jahr (vorher fälschlich ~20% angenommen); Capex/Umsatz real 8,07% (vorher fälschlich ~4% angenommen) – beide zusätzlich verfehlt. Einzige Korrektur nach oben: FCF-Marge real 21,43% (GuruFocus, vorher fälschlich als knapp verfehlt ~18% geschätzt) – klärt sich positiv auf. **K-Score dadurch von 4/5 auf 3/5 gesunken.** Bear/Base/Bull-FV entsprechend niedriger revidiert: ¥2.700/¥3.616/¥4.520 (vorher ¥3.220/¥4.746/¥5.983). **Zonen-Neueinstufung: Kurs ¥3.261 liegt jetzt in Zone 3 FAIR** (Zone-2-Obergrenze nur noch ¥3.254), nicht mehr Zone 2 ATTRAKTIV. MoS ggü. neuem Bear-FV: -20,8% (vorher -1,3% ggü. altem, zu hohem Bear-FV). **Großer Beat-and-Raise am 14.08.2026 bleibt bestätigt:** FY-Guidance angehoben – Operatives Ergebnis ¥32,64→42,22 Mrd. (+29%), Nettogewinn ¥23,81→30,56 Mrd. (+28%), Umsatz ¥130,87→141,14 Mrd., Dividende +49%. **Schnellanalyse-Cross-Check 09.09.2026 (Jack+Aegis, Conan-Bridge dritten Tag in Folge komplett ausgefallen):** Rating bleibt **BEOBACHTEN** (nicht KAUFEN), Konfidenz 🔴 NIEDRIG (54,5% VERIFIED/LIVE-Anteil), Sizing-Deckel Tier 3. Abstauber-Zone auf ¥2.700-2.900 gesenkt (nahe neuem Bear-FV). Siehe `analysen/ASAHI-quickfilter-cross-check-2026-09-09.md` (Nachtrag 2) für die vollständige Vorher/Nachher-Tabelle. | **Umkategorisiert 2026-09-04 von Talent zu Profi** (Brian: "sind das keine Talente?" – gegenrechercht und bestätigt): >50% globaler Marktanteil bei PCI-Guidewires (Top-5-Gesamtmarkt mit Boston Scientific/Terumo/Abbott/Medtronic, aber klare Führung speziell im PCI-Segment), operative Marge konstant 20-25% dank vertikal integrierter Fertigung. Das ursprüngliche "gemischte Rating" (Jarvis ABBRUCH/Jack SCHROTT/Conan BEOBACHTEN 6) war primär ein Datenlücken-Artefakt (fehlende FCF-/Bilanz-Primärquellen lösten Jacks bekannten Reflex-Abbruch-Bug aus, siehe HANDOVER.md 10.13), keine echte Geschäftsqualitäts-Schwäche – die verifizierten Kennzahlen (ROIC/ROCE 23,21%, operative Marge 29,71%, Umsatzwachstum +21,2% YoY) passen klar zu "gute bis hohe Margen und Wachstumsrate, kein Monopol" – der Profi-Definition, nicht Talents "eventuell noch unprofitabel". |
