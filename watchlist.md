...
| LGND (NASDAQ) | US53220K5048 | Ligand Pharmaceuticals | USA | Pharma-Royalty-Aggregator (asset-light) | BRIAN | 🆕 | 🟡 BEOBACHTEN – Forward-KGV ~25x bei Royalty-CAGR-Guidance ≥23% über 5 Jahre – wachstumsbereinigt (PEG grob <1,1) nicht teuer, Kurs nah am Allzeithoch (295,7 vs. 326,63 USD ATH). **MoS-Hinweis:** nicht recherchiert, nachzuholen. | **Aufgenommen 2026-09-08 auf Brians direkte Vorgabe.** Finanziert Pharma-Firmen gegen künftige Umsatzbeteiligung statt eigener Labore/Vertrieb (~90 Royalty-Rechte im Portfolio) – strukturell asset-light mit breiter Diversifikation über viele Wirkstoffe/Partner. Umsatzwachstum 14,1%, ROE 17,1%, FCF 142,1 Mio. USD. **Grund für Profi statt Champions:** gerade $700M Wandelanleihe für die XOMA-Royalty-Übernahme aufgenommen (Royalty-Buch verdoppelt) – Verschuldung/Integration noch nicht über mehrere Quartale bewiesen. **Kein voller 3-fach-Cross-Check gelaufen, nur Jarvis-Solo-Recherche.** **ISIN am 2026-09-08 korrigiert** – ursprünglich erfasste US53219L1076 hatte eine ungültige Prüfziffer (Luhn-Check fehlgeschlagen), beim Scalable-Watchlist-Sync aufgefallen; korrekte ISIN per `search_securities` verifiziert. |
