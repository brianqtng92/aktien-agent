...
| ⚙️ Profi (10) | WSO (1) | VRT, FTNT, MPWR, AIT, Disco Corp (5) | ANET, Exponent (2) | nVent Electric (1) | CrowdStrike (1) |
...
| 6920 (Tokyo) | JP3979200007 | Lasertec Corp. | Japan | Halbleiterausrüstung (EUV-Masken-Inspektion) | BRIAN | ⚠️ RISIKO | 🟡 BEOBACHTEN – KGV 41,5x, nahe 10J-Median (44,3x), über JP-Sektor-Ø (25,5x). **MoS-Hinweis:** keine spezifische Drawdown-Quelle recherchiert, aber Sektor (Halbleiterausrüstung, Nischenmonopol) strukturell stark zyklisch – analog ASML/TSM historisch 40-90%-Korrekturen möglich. | Faktisches Weltmonopol bei EUV-Masken-Inspektion, aber klassisch zyklisches Semicap-Geschäft mit hoher Kursvolatilität. **News-Ampel 2026-09-03:** 🟡 Quartalsumsatz -26% YoY, Marge -829 Bp, Aktie -14% nach Zahlen wegen Sorgen um Margen-Guidance FY2027 – bei Talent-artiger Datenlage reicht diese Verschlechterung für Gelb. |
