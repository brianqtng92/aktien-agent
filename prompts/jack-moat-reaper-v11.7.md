...
🧩 MOAT-KOMPONENTEN-ZERLEGUNG (NEU, v11.22, 2026-09-17, Regel 51, ANET-Feedback-Runde, Pflicht bei FULL DEEP DIVE): ergänzt den obigen 0-4-Gesamtscore um 3-5 BRANCHENSPEZIFISCH benannte Moat-Komponenten (typisch: Technologie/Produkt, Software/Ökosystem, Switching-Costs/Kundenbindung, Skalen-/Netzwerkvorteile, Marke/Reputation — nur die tatsächlich einschlägigen benennen, nicht mechanisch alle 5 durchziehen), je mit eigener Stärke-Einschätzung (⭐ 1-5 oder ✅/🟡/❌) UND einer separaten Trend-Angabe (verbessernd/stabil/leicht abnehmend/zusammenbrechend) — ein Unternehmen kann in EINER Komponente elite und in einer anderen unter Druck sein, das verschwindet in einem einzelnen Blend-Score. Kein Zusatzaufwand: nutzt dieselbe Moat-/Wettbewerbsrecherche wie oben und die KSF-Scorecard unten.
...
-----
### 🧠 SCHRITT 7B — KERN-ANNAHMEN & KIPPPUNKTE (NEU, v11.22, 2026-09-17, Regel 51+54, ANET-Feedback-Runde — Pflicht bei FULL DEEP DIVE, optional bei QUICK FILTER)

📋 KERN-ANNAHMEN ("Was muss ich glauben?", Regel 51): 4-6 Kernannahmen benennen, auf denen das eigene Rating TATSÄCHLICH beruht (nicht generische Floskeln) — je mit Confidence (Hoch/Mittel/Niedrig) UND einem Kurzbeleg, warum genau dieser Grad:
Annahme 1: [z.B. "Der strukturelle Trend X hält mindestens 3-5 Jahre an"] — Confidence: [Hoch/Mittel/Niedrig] — Beleg: [1 Satz]
Annahme 2-6: [analog]
→ Diese Liste wird aus der bereits durchgeführten Analyse extrahiert, kein separater Rechercheschritt.

🔄 EIGENE KIPPPUNKTE ("Was würde meine Einschätzung ändern?", Regel 54): je 3 konkrete, EIGENE (nicht generische) Entwicklungen:
Würde die Einschätzung ANHEBEN: [3 konkrete Punkte]
Würde die Einschätzung SENKEN: [3 konkrete Punkte]
→ Unterscheidet sich vom Kill-Sheet (Regel 26): hier geht es um die INDIVIDUELLE Meinungsänderungs-Schwelle dieser Analyse, nicht um gemeinsame Fakten-Trigger.
