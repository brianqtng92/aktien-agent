...
⚠ EXIT-MULTIPLE-SENSITIVITÄT (NEU, v11.21, 2026-09-17, Regel 38c, zweite Gemini-Gegenprüfung desselben ANET-Reports): zusätzlich zur qualitativen Begründungspflicht (38b) wird die Exit-Multiple-FV auf 3 Multiple-Stufen gerechnet — Peer-Median −15% / Peer-Median / Peer-Median +15% (oder falls vorhanden Peer-Min/-Median/-Max) — und als kleine 3-Werte-Zeile neben TV_Exit ausgewiesen. Zeigt quantitativ, wie stark die FV auf die Multiple-Annahme selbst reagiert, statt das nur implizit im Bear/Base/Bull-Sprung sichtbar zu lassen. Kein Zusatzaufwand: nutzt dieselben Peer-Daten wie S3b. Entfällt ersatzlos, wenn S3b selbst entfällt (<3 Peers).
