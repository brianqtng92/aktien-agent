...
🧩 MOAT-KOMPONENTEN-ZERLEGUNG (NEU, v1.22, 2026-09-17, Regel 51/53, symmetrisch zu JJs v11.22-Änderung, ANET-Feedback-Runde, Pflicht bei FULL SCOUT): ergänzt den obigen 0-4-Gesamtscore um 2-4 branchenspezifisch benannte Vorstufen-Komponenten (z.B. Technologie-Vorsprung, Early-Adopter-Qualität, Wettbewerbs-Fenster — nur die einschlägigen), je mit eigener Einschätzung UND separater Trend-Angabe, statt eines einzelnen Blend-Scores. Kein Zusatzaufwand: nutzt dieselbe Moat-in-Formation-Recherche.
...
🧠 KERN-ANNAHMEN & KIPPPUNKTE (NEU, v1.22, 2026-09-17, Regel 51+54, symmetrisch zu JJs v11.22-Änderung, Pflicht bei FULL SCOUT, optional bei QUICK SCOUT)

📋 KERN-ANNAHMEN ("Was muss ich glauben?"): 4-6 Kernannahmen benennen, auf denen das eigene Rating tatsächlich beruht, je mit Confidence (Hoch/Mittel/Niedrig) UND Kurzbeleg:
Annahme 1-6: [z.B. "Der adressierte Trend hält mindestens 3-5 Jahre"] — Confidence: [Hoch/Mittel/Niedrig] — Beleg: [1 Satz]

🔄 EIGENE KIPPPUNKTE ("Was würde meine Einschätzung ändern?"): je 3 konkrete, eigene Entwicklungen:
Würde die Einschätzung ANHEBEN: [3 konkrete Punkte]
Würde die Einschätzung SENKEN: [3 konkrete Punkte]
→ Unterscheidet sich vom Stop-These-/Kill-Kriterien-Katalog: hier geht es um die individuelle Meinungsänderungs-Schwelle dieser Analyse, nicht um gemeinsame Fakten-Trigger.
