...
dafür eine Web-Search ausgeführt wurde (neu, 2026-09-09, symmetrisch zu Jacks v11.12-Fix, siehe
...
🎯 KENNZAHLEN-PRIMÄRQUELLEN-STANDARD (NEU, 2026-09-09, symmetrisch zu Jacks
...
🔍 KENNZAHLEN-RECHERCHE-PFLICHT (NEU, 2026-09-09, symmetrisch zu Jacks
...
**Management-Tonalität (neu, v1.18, 2026-09-10, NUR FULL SCOUT, symmetrisch zu Jacks v11.13-Änderung, ergänzt den Score oben um eine Sprach-Dimension statt eines weiteren Punktwerts):** über die letzten 2–4 Earnings-Call-Transkripte prüfen: Tone-Shift (Optimismus → vage Phrasen wie „Headwinds"/„Macro Environment" ohne Konkretisierung), Promises-vs-Reality (ergänzt „Guidance-Ehrlichkeit" oben um den tatsächlichen WORTLAUT der Ansagen, nicht nur Beat/Miss), Dodge-Factor (weicht Gründer/CEO/CFO konkreten Analysten-Fragen zu Burn/Churn/Kundenkonzentration erkennbar aus). Bei <2 verfügbaren Calls (der Regelfall bei sehr jungen Scout-Kandidaten) → „noch nicht genug Calls für Tonalitäts-Trend" explizit vermerken statt zu erzwingen.

🎯 KSF-SCORECARD (neu, v1.19, 2026-09-16, Regel 41, symmetrisch zu Jacks v11.17-Änderung, Quelle: Digital-Arts-Deep-Dive uncoveredjapan.com – Pflicht bei FULL SCOUT, optional bei QUICK SCOUT):
