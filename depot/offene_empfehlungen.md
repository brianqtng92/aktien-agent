...
| Hermès | FR0000052292 | Nachkauf-Zone verlassen, kein Order-Signal mehr (Preisalarm bleibt dokumentiert) | ≤1.350€ (Abstauber-Limit aus RMS-Quick-Filter, 23.08.2026) – **Kurs 21.09. (WebSearch, ad-hoc-news.de) 1.597€**, +18% ggü. 1.352€ am 18.09. – Zone deutlich verlassen. Treiber laut Presse: breite Markt-Erleichterungsrally (Fear&Greed Richtung Greed) plus Berenberg-Buy-Bestätigung (PT 1.850€) trotz Bernstein-PT-Kürzung auf 1.750€ (schwächere China-Nachfrage). Kein neuer fundamentaler Negativ-Treiber – reine Kurserholung, Order-Limit damit vorerst nicht mehr relevant, Position bleibt beobachtet für einen erneuten Rücksetzer Richtung Zone. | RMS-TMR-Quick-Filter (23.08.2026) + JJ/Conan-Schnellanalyse-Update (2026-09-18) + TA-Monatschart-Review (2026-09-18) | 2026-09-18 | – |
