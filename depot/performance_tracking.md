...
| 18.09.2026 | 33.426,76 € | -4,59% | 7.581,58 (Proxy: SPY×9,9582, kein sauberer Tagesschlusskurs per WebSearch auffindbar) | -1,69% | 29.524,68 (Proxy: QQQ×41,035) | +0,31% | 126,77 € (unverändert – kein frischer EUR-Kurs per WebSearch auffindbar, Stand 17.09. fortgeschrieben) | -0,76% | Depot fällt weiter hinter S&P 500/MSCI World zurück (Nasdaq 100 sogar leicht im Plus) – Hauptursache diesmal eine konkrete Einzelposition: Hermès fiel laut Brians TradingView-Monatschart auf 1.352€ (-14% ggü. Vorwoche, siehe `chart_rendite.png`), womit die Nachkauf-Zone (≤1.350€) praktisch erreicht ist. Kein Material-Shift auf Gesamtmarktebene (BoJ-Hike auf 1,25% wie erwartet, keine Überraschung) |
