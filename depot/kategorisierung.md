...
| Kategorie | Ziel | Ist (24.09.2026, nach 6 Komplett-Verkäufen) | Freie Slots |
|---|---|---|---|
...
|---|---|---|---|---|---|
| 🏆 Champions (6) | Intuitive Surgical, Münchener Rück, ServiceNow, Tristel (4) | Allianz (1) | CBOE (1) | – | – |
| ⚙️ Profi (5) | – | Rambus, Cellebrite, SoFi (3) | – | – | Kraken Robotics, HawkEye 360 (2) |
| 🚀 Talent (1) | – | – | – | Rocket Lab (1) | – |

**Lesehilfe (aktualisiert 2026-09-24 nach 6 Komplett-Verkäufen):** Constellation Software, Hermès, MercadoLibre und Bank Central Asia (alle Champions) sowie Broadridge und A10 Networks (beide Profi) wurden von Brian komplett verkauft – siehe `depot/finanzen-net-zero.md`/`depot/scalable-capital.md` für die Transaktionsdetails. Die 10-7-3-Zielstruktur ist dadurch deutlich unterschritten (Champions 6/10, Profi 5/7, Talent 1/3) – kein automatisches Kauf-/Nachfüllsignal, aber ein struktureller Beobachtungspunkt für künftige Portfolio-Lücken-Suchen. Bei Talent bleibt nur noch Rocket Lab übrig, und die einzige Position dort liegt in der ungünstigsten Kombination (spekulativ + überbewertet) – das ist weiterhin der Bereich, wo eine bewusste Prüfung der These am ehesten angebracht ist, auch wenn kein automatisches Verkaufssignal vorliegt (siehe hinterlegte Nachkauf-Aufstufungs-Trigger in der Talent-Tabelle). Kraken Robotics und HawkEye 360 sind neu bei Profi und laufen bewusst unter 🔘 GRAU, weil ihre KGV-Kennzahlen (noch) verzerrt sind – das ist methodisch korrekt, keine Bewertungslücke.
...
| CBOE Holdings | 🟢 NACHKAUF-ZONE (gestaffelt) – **Full Deep Dive 16.09.2026** (3-fach-Cross-Check, siehe `analysen/CBOE-fulldeepdive-cross-check-2026-09-16.md`): Kurs $270,40 nach -4,96%-Tagesverlust (sektorweiter Zins-/FOMC-Ausverkauf, kein CBOE-spezifischer Auslöser). Alle drei DCF-Rechnungen (Jarvis/Jack/Conan, unabhängig) kommen strukturell über Analysten-Konsens ($292-318) – Ursache ist der bei CBOEs niedrigem Beta (0,41-0,64) extrem enge WACC-Terminal-g-Spread (TV-Anteil 84-87% EV), kein Rechenfehler. Peer-EV/EBITDA-Abschlag (CBOE 14,25x vs. Peer-Median 17,3x) und Konsens beide moderat über Kurs. 2 von 3 unabhängigen Beinen (Jack, Conan) kommen trotzdem auf KAUFEN. **Tranche 1 bei Stabilisierung über $268-270 (Tier 2, ~1,5-2%), Tranche 2 bei $255-262** – Technik zum Analysezeitpunkt noch schwach (unter 200D-SMA, OBV fallend), bestimmt nur die Tranchierung, nicht die Grundentscheidung. **MoS-Hinweis:** 5J-Max-Drawdown -24,4%. | Named-Beispiel Brian – **umkategorisiert 2026-09-04 von Profi zu Champions** (Brian: "extrem einmaliges Geschäftsmodell" – bestätigt: Operating-Marge ~35-53% je Periode, UND ein echtes, vertraglich/regulatorisch abgesichertes Monopol bei SPX-/VIX-Optionen – VIX ist ein CBOE-Markenzeichen, laut CBOE >98% des gesamten US-Index-Optionsvolumens läuft über CBOE-Venues. Stärkerer, konzentrierterer Moat als mehrere bestehende Champions. **Einziges Risiko, transparent benannt:** die SPX-Exklusivlizenz mit S&P Global ist vertraglich, nicht ewig – ein Lizenzverlust wäre ein echtes, wenn auch aktuell nicht akutes These-Bruch-Kriterium für die Zukunft.) |
...
| Position | CRV | Begründung Kategorie |
|---|---|---|
| Rambus | 🟡 HALTEN/BEOBACHTEN – **Full Deep Dive REFRESH 21.09.2026 (Jack+Conan, auf Brians direkte Anforderung):** Rating bestätigt **BEOBACHTEN**, kein Nachkauf beim aktuellen Kurs ($95,77, +9,33% am Tag, nach +30% Wochenrally). Rekord-Q2 2026 ($207,4 Mio. Umsatz +20,4% YoY, Non-GAAP-EPS $0,77) und angehobene Q3-Guidance ($210-216 Mio.) bestätigt, aber Kurs preist das bereits vorweg. **Echter Rating-Widerspruch in Runde 1 aufgelöst:** JJ startete mit KAUFEN (DCF-Base $110-125), Conan mit BEOBACHTEN (DCF-Base $69) – Aegis-Gegenrechnung von JJs eigenen Annahmen ergab rechnerisch nur ~$50-60, JJ bestätigte danach selbst die Inkonsistenz und revidierte auf BEOBACHTEN/HALTEN (DCF Base $50-70). **Piotroski-Divergenz aus der 09.09.-Analyse aufgelöst** (Conan bestätigt ~6,5/9, die alte 4/9-Bewertung war zu mechanisch). **Neuer Struktur-Risiko-Fund:** Südkorea-Kartellermittlung seit 15.07.2026 (Rambus + Montage Technology + Renesas, Vorwurf Preisabsprache bei Memory-Interface-Chips an Samsung/SK Hynix) – zusätzlich zur bekannten Kundenkonzentration (Top-2 38-40%, Südkorea 45-47% Umsatzanteil). TA (Twelve Data, real): RSI 59,4 neutral, Kurs über oberem Bollinger-Band (überdehnt), unter SMA200 ($107,69) – bestätigt fundamentale Vorsicht, kein Widerspruch. **Abstauber-Zone $68-75 bestätigt und gestärkt** (deckt sich fast exakt mit dem reconciliierten DCF-Base ~$60-70), siehe `analysen/RMBS-fulldeepdive-cross-check-2026-09-21.md`. Checkpoint Q3'26-Earnings 02.11.2026 + Südkorea-Kartellverfahren. | Named-Beispiel Brian (22.08.), etablierte Semiconductor-IP-Firma seit 1990 (korrigiert 2026-09-03, vorher fälschlich Talent) |
