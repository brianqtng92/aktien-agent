...
| Rambus | 🟡 HALTEN/BEOBACHTEN – KGV nahe eigenem 10J-Median (leicht darüber je nach Quelle). **MoS-Hinweis:** 5J-Max-Drawdown -48,8% (u.a. -30% allein 2022, -45% 2024) – Halbleiter-IP-Lizenzgeschäft mit Patentstreit-getriebenem, unregelmäßigem Ertragsmuster bleibt volatil. **Schnellanalyse 08.09.2026 (Jack+Aegis, Conan-Bridge ausgefallen):** Rating unverändert BEOBACHTEN, aber DNA-Check leicht verschlechtert – Piotroski F-Score 6→5, Capex/Umsatz erstmals leicht über 5%-Schwelle (5,88%). Kein hartes Ausschlusskriterium, Abstauber-Limit unverändert $75, Checkpoint Q3'26-Earnings 02.11.2026 (siehe `analysen/RMBS-quickfilter-cross-check-2026-09-08.md`). | Named-Beispiel Brian (22.08.), etablierte Semiconductor-IP-Firma seit 1990 (korrigiert 2026-09-03, vorher fälschlich Talent) |
