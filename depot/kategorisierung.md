...
| A10 Networks | 🔴 KEIN NACHKAUF – ÜBERBEWERTET (**verschärft 2026-09-08 nach Full Deep Dive**, siehe `analysen/ATEN-fulldeepdive-cross-check-2026-09-08.md`) – DCF zeigt Überbewertung in ALLEN drei Szenarien (Bear/Base/Bull, Bull sogar -12,1% unter Live-Kurs $24,59), Reverse-Engineering-Cross-Check zeigt eine implizite Markterwartung (~19,2% p.a.) über der eigenen Bull-Case-Annahme. **Zentraler Fund:** Microsoft ist mit 38% der Q2-2026-Umsätze der mit Abstand größte Einzelkunde (SEC-10-Q "Customer A"), verbunden mit einem ungewöhnlichen Optionsschein-Deal – deutliche Eskalation ggü. historischer Top-10-Konzentration (35-41%). 3-fach-Cross-Check mit größter bisheriger Divergenz: Jack (SCHROTT, Score 3/10, empfiehlt Verkauf) vs. Conan (BEOBACHTEN, Score 5,5/10, primärquellenbasiert via SEC-Filings). Jarvis-Synthese landet bei BEOBACHTEN mit reduziertem Sizing statt Verkauf oder Ausbau (Konfidenz 🔴 niedrig wegen der KI-Divergenz selbst). **MoS-Hinweis:** 6-Jahres-Historie zeigt echten Umsatzrückgang 2023 (-10,2%, Service-Provider-Capex-Schwäche) – bestätigt zyklische Schwankungsanfälligkeit. | Named-Beispiel Brian – **verschärft 2026-09-08** (vorher 🟠 teuer, jetzt 🔴 überbewertet nach Full-Deep-Dive-Rigor-Standard) |
