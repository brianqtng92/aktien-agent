...
| Rambus | 🟡 HALTEN/BEOBACHTEN – **Full Deep Dive 09.09.2026 abgeschlossen (Jack+Conan, zweiter echter 3-fach-Check nach dem OpenAI-Credits-Fix):** Rating bestätigt **BEOBACHTEN**, kein Nachkauf beim aktuellen Kurs (~$87, WebSearch zeigte fälschlich $104,69 — Ursache aufgeklärt: Verwechslung mit dem Ask-Preis). Beide KIs führten unabhängig ein DCF durch/zitierten eines: Fair Value $32-44 (Bear/Base), $68-69 (Bull) — deutlich unter dem Kurs. **Echte Divergenz beim Piotroski F-Score (Jack 4/9 verfehlt, Conan eigene Berechnung 7/9 erfüllt)** – nicht aufgelöst, siehe `analysen/RMBS-fulldeepdive-cross-check-2026-09-09.md`. Neuer, konkreter Struktur-Risiko-Fund (Conan, aus dem 10-Q): Top-2-Kundenkonzentration 38-40% des Umsatzes, 65% der Forderungen, Südkorea 45% des Q2-Umsatzes. Abstauber-Zone präzisiert auf **$68-75** (vorher pauschal $75). **MoS-Hinweis:** 5J-Max-Drawdown -48,8%, seit Juni-Hoch bereits -50% – Halbleiter-IP-Lizenzgeschäft mit Patentstreit-getriebenem, unregelmäßigem Ertragsmuster bleibt volatil. Checkpoint Q3'26-Earnings 02.11.2026. | Named-Beispiel Brian (22.08.), etablierte Semiconductor-IP-Firma seit 1990 (korrigiert 2026-09-03, vorher fälschlich Talent) |
